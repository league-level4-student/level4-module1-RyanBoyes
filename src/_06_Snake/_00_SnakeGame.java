...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "You know how to play snake right?";
	...
	private void setFoodLocation() {
		...
		int randomWidth = random1.nextInt(15);
		int randomHeight = random2.nextInt(12);
		
		Location ranLoc = new Location(randomWidth, randomHeight);
		...
		if(snake.isLocationOnSnake(ranLoc)==false) {
			foodLocation=ranLoc;
		}
	...
	private void gameOver() {
		...
		int input = JOptionPane.showOptionDialog(null, "Do  you want to play again", null, 0, -1, null, options, 0);
		//4. if they want to play again
		switch(input) {
		case 0:
			snake.reset(new Location(25,25));
			setFoodLocation();
			timer.start();
			break;
		case 1:
